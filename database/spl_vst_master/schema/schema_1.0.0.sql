...
-- Description:
-- - db schema script to create database for spl_vst_master. a master database applicable for all VST node databases.

-- ==========================================================================
drop database if exists spl_vst_master;
create database spl_vst_master DEFAULT CHARACTER SET utf8;
use spl_vst_master;
...
--
-- Table structure for table `spl_vst_master_task_lib_tbl`
--

CREATE TABLE `spl_vst_master_task_lib_tbl` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
