...
func registerRouters(router *gin.RouterGroup) {
	...
	router.GET(constants.API_DASHBOARD_VEHICLE_PER_MONTH, func(c *gin.Context) { lhelper.CommonWebRequestHandler(c, requestHandler) })
	router.GET(constants.API_DASHBOARD_VEHICLE_PER_WEEK, func(c *gin.Context) { lhelper.CommonWebRequestHandler(c, requestHandler) })
	router.GET(constants.API_DASHBOARD_AVG_TIME_PER_MONTH, func(c *gin.Context) { lhelper.CommonWebRequestHandler(c, requestHandler) })
	router.GET(constants.API_DASHBOARD_AVG_TIME_PER_WEEK, func(c *gin.Context) { lhelper.CommonWebRequestHandler(c, requestHandler) })
}
...
func requestHandler(pContext *gin.Context) (bool, interface{}) {
	...
	case constants.API_DASHBOARD_VEHICLE_PER_MONTH:
		...
		isSuccess, resultData = DashboardService{
			ExeCtx: successErrorData.(*gmodels.ExecutionContext),
		}.VehicleSummaryPerMonth(req)

		break

	case constants.API_DASHBOARD_VEHICLE_PER_WEEK:
		...
		isSuccess, resultData = DashboardService{
			ExeCtx: successErrorData.(*gmodels.ExecutionContext),
		}.VehicleSummaryPerWeek(req)

		break

	case constants.API_DASHBOARD_AVG_TIME_PER_MONTH:
		...
		isSuccess, resultData = DashboardService{
			ExeCtx: successErrorData.(*gmodels.ExecutionContext),
		}.AverageTimePerMonth(req)

		break

	case constants.API_DASHBOARD_AVG_TIME_PER_WEEK:
