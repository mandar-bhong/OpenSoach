...
import (
	...
	"opensoach.com/vst/api/webserver/service/dbaccess"
	hktconst "opensoach.com/vst/constants"
	hktmodels "opensoach.com/vst/models"
)

var SUB_MODULE_NAME = "VST.API.Service"
...
func (service ServiceConfigService) GetServiceInstanceTxn(spid int, StartDate time.Time, EndDate time.Time) (bool, interface{}) {
	...
	dbErr, servInstTxnList := dbaccess.GetServiceInstTxn(service.ExeCtx.SessionInfo.Product.NodeDbConn, cpmID, spid, StartDate, EndDate)
	if dbErr != nil {
