...
func (EndpointService) DeviceShareUserAuth(req lmodels.APIDeviceSharedUserAuthRequest) (bool, interface{}) {
	...
	dbErr, dbData := dbaccess.GetDeviceSharedUserAuthInfo(repo.Instance().Context.Master.DBConn, req.UserName, req.Password, deviceTokenModel.CpmID)
