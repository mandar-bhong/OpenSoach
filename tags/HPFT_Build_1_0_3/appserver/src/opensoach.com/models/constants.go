...
const MOD_OPER_ERR_DATABASE_DUPLICATE_ENTRY int = 1002
...
const DB_CONNECTION_MASTER int = 1
const DB_CONNECTION_NODE int = 2

const DB_OPERATION_INSERT_UPDATE int = 1
const DB_OPERATION_DELETE int = 2
