...
func registerRouters(router *gin.RouterGroup) {
	...
	router.POST(constants.API_USER_FORGOT_PASSWORD, func(c *gin.Context) { lhelper.CommonWebRequestHandler(c, requestHandler) })
	router.POST(constants.API_USER_RESET_PASSWORD, func(c *gin.Context) { lhelper.CommonWebRequestHandler(c, requestHandler) })
}
...
func requestHandler(pContext *gin.Context) (bool, interface{}) {
	...
	case constants.API_USER_CU_INFO_MASTER:
		...
		isSuccess, resultData = UserService{
			ExeCtx: successErrorData.(*gmodels.ExecutionContext),
		}.GetCUUserInfo(successErrorData.(*gmodels.ExecutionContext).SessionInfo.UserID)
	...
	case constants.API_USER_FORGOT_PASSWORD:

		reqData := lmodels.APIForgotPasswordRequest{}
		...
		isSuccess, resultData = UserService.ForgotPassword(UserService{}, reqData)

		break

	case constants.API_USER_RESET_PASSWORD:

		reqData := lmodels.APIResetPasswordRequest{}
		...
		isSuccess, resultData = UserService.ResetPassword(UserService{}, reqData)
