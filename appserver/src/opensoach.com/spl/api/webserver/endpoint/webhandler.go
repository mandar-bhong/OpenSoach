...
func registerRouters(router *gin.RouterGroup) {
	...
	router.POST(constants.API_ENDPOINT_DEVICE_USER_CPM_LIST, func(c *gin.Context) { lhelper.CommonWebRequestHandler(c, requestHandler) })
}
...
func requestHandler(pContext *gin.Context) (bool, interface{}) {
	...
	case constants.API_ENDPOINT_DEVICE_USER_LIST:

		devAuthReq := lmodels.APIDeviceUserListRequest{}
	...
	case constants.API_ENDPOINT_DEVICE_USER_CPM_LIST:

		devAuthReq := lmodels.APIDeviceUserCPMListRequest{}
		...
		isSuccess, resultData = EndpointService.GetDeviceUserCPMList(EndpointService{}, devAuthReq)
