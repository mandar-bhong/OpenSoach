...
@Component({
  ...
  styleUrls: ['./view-medicine-schedule.component.css', '../../transaction-details/transaction-details.component.css'],
  animations: [
...
export class ViewMedicineScheduleComponent implements OnInit, OnDestroy {
