...
INSERT INTO `spl_hpft_action_txn_tbl` (`id`, `uuid`, `cpm_id_fk`, `patient_conf_id_fk`, `admission_id_fk`, `txn_data`, `runtime_config_data`, `scheduled_time`, `txn_state`, `conf_type_code`, `client_updated_at`, `created_on`, `updated_on`, `updated_by`) VALUES
	(1, 'a23b740a-b84d-42c4-a791-3281ef296b34', 3, 1, 1, '{"value": "99", "comment": "normal temperature"}', NULL, timestamp(ADDTIME(( curdate() - INTERVAL 3 DAY),'04:50:00')), 1, 'Monitor', timestamp(ADDTIME(( curdate() - INTERVAL 3 DAY),'04:58:04')), timestamp(ADDTIME(( curdate() - INTERVAL 3 DAY),'04:58:11')), timestamp(ADDTIME(( curdate() - INTERVAL 3 DAY),'04:58:11')), 2),
	...
	(4, 'a23b740a-b84d-42c4-a791-3281ef296b37', 3, 1, 1, '{"value": "96", "comment": "normal temperature"}', NULL, timestamp(ADDTIME(( curdate() - INTERVAL 3 DAY),'13:50:00')), 1, 'Monitor', timestamp(ADDTIME(( curdate() - INTERVAL 3 DAY),'13:55:00')), timestamp(ADDTIME(( curdate() - INTERVAL 3 DAY),'13:55:00')), timestamp(ADDTIME(( curdate() - INTERVAL 3 DAY),'13:55:00')), 2),
	...
	(6, 'a23b740a-b84d-42c4-a791-3281ef296b39', 3, 1, 1, '{"value": "99", "comment": "normal temperature"}', NULL, timestamp(ADDTIME(( curdate() - INTERVAL 2 DAY),'07:50:00')), 1, 'Monitor', timestamp(ADDTIME(( curdate() - INTERVAL 2 DAY),'07:48:00')), timestamp(ADDTIME(( curdate() - INTERVAL 2 DAY),'07:48:00')), timestamp(ADDTIME(( curdate() - INTERVAL 2 DAY),'07:48:00')), 2),
	...
	(11, 'a23b740a-b84d-42c4-a791-3281ef296b44', 3, 1, 1, '{"value": "96", "comment": "normal temperature"}', NULL, timestamp(ADDTIME(( curdate() - INTERVAL 1 DAY),'10:50:00')), 1, 'Monitor', timestamp(ADDTIME(( curdate() - INTERVAL 1 DAY),'10:50:00')), timestamp(ADDTIME(( curdate() - INTERVAL 1 DAY),'10:50:00')), timestamp(ADDTIME(( curdate() - INTERVAL 1 DAY),'10:50:00')), 2),
	(12, 'a23b740a-b84d-42c4-a791-3281ef296b45', 3, 1, 1, '{"value": "96.5", "comment": "normal temperature"}', NULL, timestamp(ADDTIME(( curdate() - INTERVAL 1 DAY),'13:50:00')), 1, 'Monitor', timestamp(ADDTIME(( curdate() - INTERVAL 1 DAY),'13:55:00')), timestamp(ADDTIME(( curdate() - INTERVAL 1 DAY),'13:55:00')), timestamp(ADDTIME(( curdate() - INTERVAL 1 DAY),'13:55:00')), 2),
