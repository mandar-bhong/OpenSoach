...
INSERT INTO `spl_node_sync_config_tbl` (`store_name`, `updated_on`, `has_qry`, `select_count_qry`, `select_qry`, `insert_qry`, `update_qry`) VALUES
	...
	('patient_master_tbl','2018-01-01 00:00:00','select count(*) as count from spl_hpft_patient_master_tbl where uuid = ?','select count(*) as count from spl_hpft_patient_master_tbl where updated_on > ?','select * from spl_hpft_patient_master_tbl where updated_on > ?','insert_qry','update_qry'),
	
	('schedule_tbl','2018-01-01 00:00:00','select count(*) as count from spl_hpft_patient_conf_tbl where uuid = ?','select count(*) as count from spl_hpft_patient_conf_tbl where updated_on > ?','select * from spl_hpft_patient_conf_tbl where updated_on > ?','insert_qry','update_qry'),
	
	('patient_admission_tbl','2018-01-01 00:00:00','select count(*) as count from spl_hpft_patient_admission_tbl where uuid = ?','select count(*) as count from spl_hpft_patient_admission_tbl where updated_on > ?','select * from spl_hpft_patient_admission_tbl where updated_on > ?','insert_qry','update_qry'),
	
	('patient_personal_details_tbl','2018-01-01 00:00:00','select count(*) as count from spl_hpft_patient_personal_details_tbl where uuid = ?','select count(*) as count from spl_hpft_patient_personal_details_tbl where updated_on > ?','select * from spl_hpft_patient_personal_details_tbl where updated_on > ?','insert_qry','update_qry'),
	
	('patient_medical_details_tbl','2018-01-01 00:00:00','select count(*) as count from spl_hpft_patient_medical_details_tbl where uuid = ?','select count(*) as count from spl_hpft_patient_medical_details_tbl where updated_on > ?','select * from spl_hpft_patient_medical_details_tbl where updated_on > ?','insert_qry','update_qry'),
	
	('action_txn_tbl','2018-01-01 00:00:00','select count(*) as count from spl_hpft_action_txn_tbl where uuid = ?','select count(*) as count from spl_hpft_action_txn_tbl where updated_on > ?','select * from spl_hpft_action_txn_tbl where updated_on > ?','insert_qry','update_qry');
