...
export class ListComponent implements OnInit {
	...
	public initDataItems() {
		...
		this.tempdata.push({ ward: "3A/312", name: "Sumeet karande", mobile: "9878978980" });
		this.tempdata.push({ ward: "3B/323", name: "Amol Patil", mobile: "32423432432" });
		this.tempdata.push({ ward: "2A/643", name: "Sanjay Mohan", mobile: "453545352" });
		this.tempdata.push({ ward: "4A/515", name: "Sanjay Sawant", mobile: "9878978980" });
		this.tempdata.push({ ward: "5A/616", name: "Parveen", mobile: "5645645665" });
		this.tempdata.push({ ward: "3A/312", name: "Sumeet karande", mobile: "9878978980" });
		this.tempdata.push({ ward: "3B/323", name: "Amol Patil", mobile: "32423432432" });
		this.tempdata.push({ ward: "2A/643", name: "Sanjay Mohan", mobile: "453545352" });
		this.tempdata.push({ ward: "4A/515", name: "Sanjay Sawant", mobile: "9878978980" });
