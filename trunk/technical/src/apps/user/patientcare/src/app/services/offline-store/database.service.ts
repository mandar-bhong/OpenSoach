...
let selectQueries = new Map([
    [ "patientlist", "select fname,lname,bed_no,mob_no,status,attended,sp_id,sp_name from patient_admission_tbl as padmsn inner join patient_master_tbl as patient on patient.id = padmsn.patient_id inner join service_point_tbl as sp on sp.id = padmsn.sp_id" ],
