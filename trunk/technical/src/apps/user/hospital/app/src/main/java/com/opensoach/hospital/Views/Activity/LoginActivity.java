...
import com.opensoach.hospital.Model.Communication.APIResponseModel;
...
//    }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Integer> {
        ...
        protected Integer doInBackground(Void... params) {
            ...
            String jsonData =  PacketHelper.GetAPIAuthRequestJson(mEmail,mPassword);
            ...
            Request request = builder.addHeader("Content-Type", "application/json")
                    .post(body)
                    .url(Constants.WEB_SERVICE_URL+Constants.API_VALIDATE_AUTH)
                    .build();
            ...
            try {
                ...
                switch (response.code()) {
                    case 200:
                        ...
                        responseModel = new Gson().fromJson(responseJson, APIResponseModel.class);
        ...
        protected void onPostExecute(final Integer statusCode) {
            ...
            switch (statusCode){
                case 0:
                    AppRepo.getInstance().setUserName(mEmail);
                    AppRepo.getInstance().setPassword(mPassword);
                    Intent i = new Intent(LoginActivity.this, MainActivity.class);
                    startActivity(i);
                    finish();
                    break;
                case 500:
                    //TODO Network error show
