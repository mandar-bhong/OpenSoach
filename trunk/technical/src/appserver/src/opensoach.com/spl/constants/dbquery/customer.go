...
const QUERY_GET_PRODUCT_ASSOCIATION_BY_CUST_ID = `Select cpm.id as id,cpm.prod_id_fk as prod_id_fk,prod.prod_code as prod_code,cpm.dbi_id_fk as dbi_id_fk,dbi.dbi_name as dbi_name From spl_master_cust_prod_mapping_tbl cpm
