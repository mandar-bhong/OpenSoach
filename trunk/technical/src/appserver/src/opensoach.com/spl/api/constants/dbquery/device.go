...
const QUERY_SPL_MASTER_DEVICE_TABLE_SELECT_BY_FILTER = `Select dev.id as id,dev.cust_id_fk as cust_id_fk,cust.cust_name as cust_name,dev.serialno as serialno,dev.dev_state as dev_state,dev.dev_state_since as dev_state_since,dev.created_on as created_on,dev.updated_on as updated_on 
