...
const QUERY_COMPLAINT_TABLE_SELECT_BY_FILTER = `Select spcomplaint.id as id,sp_name,complaint_title,description,complaint_by,raised_on,complaint_state,closed_on  From spl_hkt_sp_complaint_tbl spcomplaint
