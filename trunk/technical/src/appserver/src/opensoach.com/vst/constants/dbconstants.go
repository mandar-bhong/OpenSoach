...
const DB_VEHICLE_TOKEN_STATE_IN_PROGRESS = 1
const DB_VEHICLE_TOKEN_STATE_CREATED = 2
const DB_VEHICLE_TOKEN_STATE_EXECUTED = 3

const PROCESS_TYPE_TASK_CONFIG = 1
