...
@Component({
  selector: 'app-view-intake-schedule',
  templateUrl: './view-intake-schedule.component.html',
  styleUrls: ['./view-intake-schedule.component.css', '../../transaction-details/transaction-details.component.css'],
  animations: [
...
export class ViewIntakeScheduleComponent implements OnInit {
