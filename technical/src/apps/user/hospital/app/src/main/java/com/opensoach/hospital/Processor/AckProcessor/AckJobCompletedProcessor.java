...
public class AckJobCompletedProcessor implements IProcessor {
    ...
    public PacketProcessResultModel Process(PacketDecodeResultModel resultModel) {
        ...
        try {
            ...
            dbJobCardTableRowModelItem.setActualEndDate( packetJobStartDataModel.StopTime);

            if (ackModel.Payload.Ack == Constants.RESPONSE_ACK_SUCCESS) {
                dbJobCardTableRowModelItem.setState(Constants.JOB_STATE_COMPLETED);
