...
export class DatabaseSchemaService {
    ...
    schema = [
        ...
        "CREATE TABLE IF NOT EXISTS schedule_tbl (admission_uuid TEXT, uuid TEXT, conf_type_code TEXT, conf TEXT,end_date DATETIME, updated_on DATETIME, sync_pending INTEGER, sync_pending_time DATETIME)",
