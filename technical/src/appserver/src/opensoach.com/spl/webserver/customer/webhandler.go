...
func requestHandler(pContext *gin.Context) (bool, interface{}) {
	...
	case constants.API_CUSTOMER_OSU_UPDATE:

		reqData := &lmodels.DBCustomerUpdateRowModel{}
	...
	case constants.API_CUSTOMER_SERVICE_POINT_ASSCOCIATION:
		...
		isSuccess, resultData = CustomerService{
			ExeCtx: successErrorData.(*gmodels.ExecutionContext),
		}.GetCustServicePoint(recReq.RecId)

		break

	case constants.API_CUSTOMER_SERVICE_POINT_ASSCOCIATION_UPDATE:

		reqData := lmodels.APICustSpCountUpdateRequest{}
