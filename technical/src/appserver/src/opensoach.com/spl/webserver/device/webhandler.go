...
func registerRouters(router *gin.RouterGroup) {
	...
	router.GET(constants.API_DEVICE_OSU_LIST_SHORT, func(c *gin.Context) { lhelper.CommonWebRequestHandler(c, requestHandler) })
	router.GET(constants.API_DEVICE_OSU_INFO_MASTER, func(c *gin.Context) { lhelper.CommonWebRequestHandler(c, requestHandler) })
}
...
func requestHandler(pContext *gin.Context) (bool, interface{}) {
	...
	case constants.API_DEVICE_OSU_LIST_SHORT:
	...
	case constants.API_DEVICE_OSU_INFO_MASTER:
		...
		isSuccess, resultData = DeviceService.GetDeviceInfo(DeviceService{}, recReq.RecId)
