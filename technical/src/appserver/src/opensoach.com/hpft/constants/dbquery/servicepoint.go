...
const QUERY_DELETE_DEV_SP_MAPPING_TABLE_ROW = `Delete From spl_node_dev_sp_mapping Where dev_id_fk = :dev_id_fk and sp_id_fk = :sp_id_fk  And cpm_id_fk = :cpm_id_fk`
